  ...
  function handleDecoded(raw: string) {
    try {
      ...
      if (err instanceof UpiParseError) {
        ...
        setError("Couldn't read that code. Try again or enter the UPI ID manually.");
      }
    }
  }
